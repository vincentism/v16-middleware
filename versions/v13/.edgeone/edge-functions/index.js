...
// Generated at: 2026-01-20T08:12:47.914Z
// ============================================================
        ...
        if (middlewareResponse) {
          ...
          if (hasNext) {
            ...
            headers.forEach((value, key) => {
              ...
              // 排除内部使用的头和不应覆盖的头
              if (!lowerKey.startsWith('x-middleware-') && !skipHeaders.has(lowerKey)) {
