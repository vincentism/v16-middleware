...
本文档提供了完整的测试用例清单，用于验证 Next.js 中间件在不同版本下的功能，特别是在 EdgeOne Pages 平台上的部署验证。
...
- [ ] **TC-12-012**: 在 EdgeOne Pages 上构建成功
  - 预期: 构建无错误
  - 实际结果: 

- [ ] **TC-12-013**: 在 EdgeOne Pages 上中间件正常执行
  - 预期: 部署后中间件功能正常
  - 实际结果: 
...
- [ ] **TC-13-012**: 在 EdgeOne Pages 上构建成功
  - 预期: 构建无错误
  - 实际结果: 

- [ ] **TC-13-013**: 在 EdgeOne Pages 上所有功能正常
  - 预期: 部署后所有中间件功能正常
  - 实际结果: 
...
- [ ] **TC-15-010**: 在 EdgeOne Pages 上构建成功
  - 预期: 构建无错误
  - 实际结果: 

- [ ] **TC-15-011**: 在 EdgeOne Pages 上 Node.js runtime 正常工作
...
- [ ] **TC-16-014**: 在 EdgeOne Pages 上构建成功
  - 预期: 构建无错误
  - 实际结果: 

- [ ] **TC-16-015**: 在 EdgeOne Pages 上 proxy.ts 正常工作
  - 预期: 部署后 proxy 功能正常
  - 实际结果: 

- [ ] **TC-16-016**: 验证 EdgeOne Pages 支持 proxy.ts
...
- [ ] **TC-EDGEONE-004**: 验证中间件在 EdgeOne Pages 上执行
  - 预期: 中间件正常执行，响应头正确
  - 实际结果: 
...
| Next.js 版本 | EdgeOne Pages 支持 | 主要问题 | 建议 |
|-------------|-------------------|---------|------|
| 12.x | | | |
| 13.x/14.x | | | |
| 15.x | | | |
